...
//if (window.location.hostname === 'localhost') 
{
    ...
    var hostName = "climateserv.servirglobal.net";
...
function submitDataRequest() 
{
	...
	//alert(operationValue +" " + dataTypeValue);
	...
	//dateBeginValue = document.getElementById("datepickerbegin").value;
	//dateEndValue = document.getElementById("datepickerend").value;
	if($("#typemenu").val() == "IMERG1Day") {
		//var filledBeginValue = new Date(dateBeginValue);
		//var imergStart = new Date("03/08/2015");
		//if(filledBeginValue < imergStart) { dateBeginValue = "03/08/2015"; }

			var minValue = new Date("03/08/2015");
			var maxValue = new Date("07/31/2016");
			var firstValue = new Date($('#datepickerbegin').val());
			var secondValue = new Date($('#datepickerend').val());
			if(firstValue < minValue) {  dateBeginValue = "03/08/2015"; alert("Please Note: Data Start Date is 03/08/2015!");}
	...
	//alert(dateBeginValue+" " +dateEndValue);    
    ...
    //alert(dataType_Option_Value+"||" +climate_DataType_OptionValue);
    // New Params
 ...
 //alert(dateType_Category+"|"+operationValue+"|"+dataTypeValue+"|"+dateintervalValue);
	...
	//alert(dataTypeValue+"|"+dateBeginValue+"|"+dateEndValue+"|"+dateintervalValue+"|"+operationValue+"|"+dateType_Category+"|"+isZip_CurrentDataType);
	clickEnabled = true;
    if (clickEnabled) {
        data['layerid'] = "country"; //= layerIds[selectedLayer]; // = "country";
        data['featureids'] = 216;  //= selectedFeatures.join(); // = 216;
		//alert(data['layerid'] + " | "+ data['featureids']);
    } else {
		data['geometry'] ='{"type":"Polygon","coordinates":[[[11.4,24.69],[23.76,18.01],[2.28, 17.49],[11.4,24.69]]]}';
        //data['geometry'] =currentStringPolygon; // = {"type":"Polygon","coordinates":[[[11.4,24.69],[23.76,18.01],[2.28, 17.49],[11.4,24.69]]]}
		//alert("geometry: "+ data['geometry']);
    }
	...
	//alert(baserequesturl); //http://chirps.nsstc.nasa.gov/chirps/
...
function select_dataType_Changed(theOptionValue)
{
    ...
    else
    {
        ...
        if(theOptionValue == "0")
        {
			$("#datepickerbegin").val("03/08/2015");
			$("#datepickerend").val("07/31/2016");
